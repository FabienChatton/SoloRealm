    ...
    public CraftingTableMachine() {
        super(new EdgeIOSettings[]{EdgeIOSettings.INPUT_OUTPUT, EdgeIOSettings.INPUT},
            new MachineProcessRecipe[]{
                new MachineProcessRecipe(new IngredientPair(IngredientType.ORE, IngredientMaterial.COKE_OVEN_BRICK),
                    new IngredientPair(IngredientType.RAW, IngredientMaterial.SAND), new IngredientPair(IngredientType.RAW, IngredientMaterial.CLAY))
        });
    }
